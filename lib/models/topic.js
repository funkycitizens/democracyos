...
var TopicSchema = new Schema({
  ...
  showAbstain: { type: Boolean, required: true, default: true },
  yeaLabel: { type: String, required: true },
  nayLabel: { type: String, required: true },
  abstainLabel: { type: String, required: true },
